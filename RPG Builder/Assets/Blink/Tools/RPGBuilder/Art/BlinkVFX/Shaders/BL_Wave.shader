	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float Alpha = ( smoothstepResult9 * input.ase_color.a * _Alpha );
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( smoothstepResult9 * input.ase_color.a * _Alpha );
...
WireConnection;19;6;11;0
ASEEND*/
//CHKSM=433E2DCD00A7421F131AF8D0E468792F8BD3A796