...
namespace BLINK.RPGBuilder.Managers
{
    public class CombatManager : MonoBehaviour
    {
        ...
        public void FIND_NEARBY_UNITS(CombatEntity nodeCombatInfo, GameObject projectileGO, RPGAbility ability, ProjectileHitDetection projREF)
        {
            var rank = nodeCombatInfo.GetCurrentAbilityRank(ability, true);
        ...
        public void EXECUTE_GROUND_ABILITY(CombatEntity casterEntity, RPGAbility ability, RPGCombatDATA.CombatVisualActivationType activationType, RPGAbility.RPGAbilityRankData abilityRank)
        {
            ...
            GameEvents.Instance.OnTriggerVisualEffectsList(casterEntity, abilityRank.VisualEffectEntries, ActivationType.Completed);
            GameEvents.Instance.OnTriggerAnimationsList(casterEntity, abilityRank.AnimationEntries, ActivationType.Completed);
            GameEvents.Instance.OnTriggerSoundsList(casterEntity, abilityRank.SoundEntries, ActivationType.Completed, casterEntity.transform);
            ...
            switch (effect.effectType)
            {
                ...
                case RPGEffect.EFFECT_TYPE.RollLootTable:
                    ...
                    foreach (var t1 in lootTableREF.lootItems)
                    {
                        ...
                        totalItemDropped++;
                        if (lootTableREF.LimitDroppedItems && totalItemDropped >= lootTableREF.maxDroppedItems) break;
                    }
